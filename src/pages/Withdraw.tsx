      ...
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <div className="bg-white rounded-xl shadow p-6">
          ...
          <div className="flex space-x-4">
            <button className="flex-1 border rounded-lg py-2 text-gray-700 font-medium hover:bg-gray-100">Bank Account</button>
            <button className="flex-1 border rounded-lg py-2 text-white bg-[#1a1a1a] font-medium">GbesePay Wallet</button>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow p-6 space-y-4">
          ...
          <div>
            ...
            <input type="text" placeholder="Enter token standard" className="w-full px-4 py-2 border rounded-lg" />
          </div>
          ...
          <div className="flex items-center space-x-2">
            ...
            <label htmlFor="attach-debt" className="text-sm">Attach debt obligations</label>
          </div>

          <button className="bg-gray-700 hover:bg-gray-800 text-white px-6 py-2 rounded-lg">Withdraw Now</button>
        </div>
      </div>
    </div>
  );
