      ...
      <main className="flex-1 flex  justify-center bg-[#F9FAFB] min-h-screen">
        <div className="w-full max-w-xl my-10">
          ...
          <form className="space-y-2" onSubmit={handleSubmit}>
            <div>
              <label className="block text-sm font-medium text-[#6D6D6D] mb-1">First Name</label>
              <input
                id="firstName"
                name="firstName"
            ...
            <div>
              <label className="block text-sm font-medium text-[#6D6D6D] mb-1">Last Name</label>
              <input
                id="lastName"
                name="lastName"
            ...
            <button
              type="submit"
              disabled={isPending}
              className="w-full bg-[#05238C] text-white py-3 rounded-lg font-semibold mt-7 pointer hover:bg-[#CDD7F6] hover:text-[black] transition-colors duration-300 ease-in-out"
            >
              Create Account
            </button>
          </form>
