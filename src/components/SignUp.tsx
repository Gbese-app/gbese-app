...
const SignUp = () => {
  return (
    <div className="min-h-screen flex">
      ...
      <aside className="w-1/4 bg-[#021346] text-white p-6 flex flex-col items-center relative">
        ...
        <div className="relative w-full max-w-xs flex flex-col items-center mt-35">
          <img
            src="/images/Combo Chart 1.png"
            alt="Activity Breakdown"
            className="rounded-lg shadow-lg z-10 w-[270px]"
          />
          <img
            src="/images/my-debts-card.png"
            alt="My Debts"
            className="absolute top-[25%] right-[-10%] z-20 w-25 h-5"
          />
          <img
            src="/images/transaction-history.png"
            alt="Transaction History"
            className="absolute top-[50%] left-[-4%] z-40 w-28"
          />
        </div>

        
        <div className="mt-35 text-center px-6">
          <h2 className="text-3xl font-bold leading-tight">Shift Your Debt, Breathe Again.</h2>
          <p className="text-md mt-6 text-gray-200">Join where credit no be wahala</p>
        </div>
      </aside>
      ...
      <main className="flex-1 flex items-center justify-center bg-[#F9FAFB] min-h-screen">
        <div className="w-full max-w-xl p-8">
          <h1 className="text-[40px] font-bold text-[#0B0B0B] text-center mb-5">Create an account</h1>
          <p className="text-center text-sm mb-15 text-[#4B5563]">
            Have an account?{" "}
          ...
          <div className="text-center mb-7 font-boldn">OR</div>
