  ...
  return (
    <div className="app-container">
      <section className="how-it-works">
        ...
        <p>
          The Debt Shuffle is a unique community-driven debt redistribution program designed to help
          participants manage and potentially reduce their debt through collective support.
        </p>
        <div className="features-grid">
          ...
          <div>
            ...
            <div className="feature-details">
              <h3>How it works</h3>
              <p>
                Our algorithm redistributes debt among participants based on financial capacity.
              </p>
            </div>
          </div>
          <div>
