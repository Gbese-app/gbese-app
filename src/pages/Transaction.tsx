        ...
        <div className="flex flex-col w-full h-full px-9 py-9">
            ...
            <main className="my-7 p-4 rounded-lg bg-white">
                ...
                <section className="my-5">
                    <Button title={"All Status"} style="border border-[#ACBCF0] px-2 text-xs py-1 rounded-lg bg-[#ACBCF0] mr-2 "/>
                    <Button title={"Successful"} style="border border-[#ACBCF0] px-2 text-xs py-1 rounded-lg mr-2"/>
                    <Button title={"Pending"} style="border border-[#ACBCF0] px-2 text-xs py-1 rounded-lg mr-2" />
                    <Button title={"Failed"} style="border border-[#ACBCF0] px-2 text-xs py-1 rounded-lg mr-2"/>
                </section>
