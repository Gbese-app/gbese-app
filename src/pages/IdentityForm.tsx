...
const IdentityForm: React.FC<Props> = ({ onNext, onBack, onUpdate, data }) => {
    ...
    return (
        <main className="flex items-center justify-center min-h-[90vh] bg-gray-50 p-6"> {/* Increased the height here */}
            <div className="bg-white p-8 rounded-xl shadow-md w-full max-w-4xl">
                ...
                <div className="bg-blue-50 text-blue-700 border border-blue-100 rounded-md p-3 mb-4 text-sm leading-relaxed">
                    Please upload a clear photo or scan of your ID, ensuring your name, photo, and ID number are
                    fully visible without glare, blur, or cropping.
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                    <div className="border-dashed border-2 border-gray-300 rounded-md p-4 flex flex-col items-center justify-center">
                        ...
                        <input type="file" className="hidden" id="front-upload" onChange={(e) => handleFileChange(e, true)} />
                        <label htmlFor="front-upload" className="bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium py-1 px-3 rounded-md cursor-pointer text-xs">
                            Browse
                        </label>
                        {frontImage && (
                            <div className="mt-2">
                    ...
                    <div className="border-dashed border-2 border-gray-300 rounded-md p-4 flex flex-col items-center justify-center">
                        ...
                        <p className="text-gray-500 text-xs mb-1">Supported: JPG, PNG, PDF (Max 5MB)</p>
                        <input type="file" className="hidden" id="back-upload" onChange={(e) => handleFileChange(e, false)} />
                        <label htmlFor="back-upload" className="bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium py-1 px-3 rounded-md cursor-pointer text-xs">
                            Browse
                        </label>
                        {backImage && (
                            <div className="mt-2">
