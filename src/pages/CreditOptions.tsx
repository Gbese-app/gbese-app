	...
	<g fill="none" stroke="#000" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
		...
		<circle cx="6" cy="5" r="3" />
            ...
            <div className="card-details">
              <p>Interest rate <span className="bold">{option.interest}</span></p>
              <p>Terms <span className="bold">{option.terms}</span></p>
              <p>Min–Max <span className="bold">{option.minMax}</span></p>
            </div>
