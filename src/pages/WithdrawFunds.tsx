  ...
  return (
    <div className="p-6 bg-blue-50 min-h-screen text-gray-800">
      ...
      <div className="bg-white p-4 rounded-lg shadow mb-6">
        ...
        <button
  className={`px-4 py-2 w-100 rounded border cursor-pointer ${method === 'bank' ? 'bg-blue-100 border-blue-600 text-blue-700 font-bold' : 'border-gray-300 text-gray-600'}`}
  onClick={() => handleMethodChange('bank')}
>
  Bank Account
</button>
<button
  className={`px-4 py-2 w-100 rounded border cursor-pointer ${method === 'wallet' ? 'bg-blue-100 border-blue-600 text-blue-700 font-bold' : 'border-gray-300 text-blue-600 hover:bg-blue-100 text-blue-700'}`}
