      ...
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <div className="bg-white rounded-xl shadow p-6">
          ...
          <div className="flex space-x-4">
            <button
              className={`px-4 py-2 w-full rounded border cursor-pointer ${method === 'bank' ? 'bg-blue-100 border-blue-600 text-blue-700 font-bold' : 'border-gray-300 text-black-600'}`}
            ...
            {showPopup && (
              <div className="popup-overlay">
                <div className="flex popup-box w-60 text-center">
                  ...
                  <p className="text-sm">
                    You're good to go. Withdraw your funds straight to your wallet anytime
                  </p>
                </div>
              </div>
            )}
            <div className={`page-content ${showPopup ? 'blurred' : ''}`}>{/* Actual page */}</div>
          </div>
        </form>
        ...
        <div className="fixed inset-0 backdrop-blur-lg bg-opacity-40 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-white p-10 sm:p-6 rounded-lg shadow-xl relative w-full max-w-sm sm:max-w-md">
            ...
            <div className="text-center">
              <svg
                className="text-green-600 text-5xl mb-2 ml-33 sm:ml-45"
                xmlns="http://www.w3.org/2000/svg"
                width="34"
                height="34"
                viewBox="0 0 2048 2048"
