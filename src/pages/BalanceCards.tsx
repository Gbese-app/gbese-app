...
const BalanceCards = ({ availableBalance = 500000, walletBalance = 50000 }: BalanceCardsProps) => {
  ...
  return (
    <>
      ...
      <p className="page-subtitle">See debt for your friend hand? Help am throw am away!</p>
